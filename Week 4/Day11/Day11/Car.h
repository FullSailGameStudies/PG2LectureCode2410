...
public:
	...
	{}
	Car(std::string carCSVData, char delimiter);

	void SerializeCSV(std::ostream& outStream, char delimiter);
	void DeserializeCSV(const std::string& carCSVData, char delimiter);
